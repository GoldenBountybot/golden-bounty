        ...
        <div className="max-w-none mx-auto w-full flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center justify-center w-8 h-8 rounded-full overflow-hidden"
              ...
              <img src="https://cdn.jsdelivr.net/gh/GoldenBountybot/golden-bounty-assets@main/b44/89345e410_file_00000000f5f88207ba2a1422c54f7ec0.png" alt="Bounty Bot" className="w-full h-full object-cover" />
            </div>
