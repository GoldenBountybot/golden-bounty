...
const METHODS = [
  ...
  { id: 'phantom-sol', label: 'Phantom (Solana)', logo: LOGOS.phantom, badge: 'S', badgeClass: 'bg-purple-500 text-white ring-purple-300', color: '#7868e6', solidBg: true, hint: 'Connect Phantom & pay USDC/SOL (Solana) — auto credit' },
