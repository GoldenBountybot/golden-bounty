  ...
  return (
    <div className="min-h-screen text-amber-100 flex flex-col relative" style={{ background: 'linear-gradient(to bottom, #1a1108, #0d0905)', ...W }}>
      ...
      <main className="max-w-md w-full mx-auto px-4 py-0.5 flex flex-col gap-0.5 flex-1">
        ...
        {phase === 'idle' && (
          <button onClick={start} disabled={balance < bet} className="w-full rounded-xl transition-all disabled:opacity-40 relative overflow-hidden block -my-8" style={{ ...W }}>
            <img src="https://media.base44.com/images/public/6a5698edffaa42a5b6637776/05e0ce128_file_00000000f0e081fa9fc8c4a6f2cba0c4.png" alt="Bet" className="w-full h-auto block scale-140" />
