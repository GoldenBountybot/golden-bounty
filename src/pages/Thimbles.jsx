...
export default function Thimbles() {
  ...
  const winChance = (rtp / 100) * (mode === 'two' ? 0.7 : 0.9);
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden relative" style={{ background: 'linear-gradient(to bottom, #1a191e, #100f14)', fontFamily: 'Georgia, serif' }}>
      ...
      <main className="max-w-none lg:max-w-[620px] xl:max-w-[700px] w-full mx-auto px-3 py-1 flex flex-col gap-1 flex-1 relative z-10" style={{ marginTop: '-60px' }}>
        ...
        <div className="relative w-full" style={{ marginTop: '-124px', marginBottom: '-110px' }}>
      ...
      {/* Cash display */}
      <div className="w-full max-w-none lg:max-w-[620px] xl:max-w-[700px] mx-auto px-3 pb-1 relative z-10">
