...
export default function Thimbles() {
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden relative" style={{ background: 'linear-gradient(to bottom, #1a191e, #100f14)', fontFamily: 'Georgia, serif' }}>
      ...
      <main className="max-w-md lg:max-w-7xl w-full mx-auto px-3 py-1 flex flex-col gap-1 flex-1 relative z-10" style={{ marginTop: '-60px' }}>
      ...
      {/* Cash display */}
      <div className="w-full max-w-md lg:max-w-7xl mx-auto px-3 pb-1 relative z-10">
