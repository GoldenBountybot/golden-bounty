      ...
      >
        <div className="max-w-none mx-auto pl-4 pr-0 lg:px-6 pb-0 flex items-center justify-between" style={{ paddingTop: topInset }}>
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <div className="relative shrink-0 self-end translate-y-[13px] w-12 h-12">
              <button
                ...
                className="absolute -top-[34px] left-1/2 translate-x-[calc(-50%+52px)] flex items-center gap-1.5 pl-2 pr-2.5 py-1 rounded-full transition-all active:scale-95 z-30"
                style={{
          ...
          <div className="flex flex-col items-end gap-1.5 self-end mr-2 -translate-y-2">
            <span className="block -translate-x-[70px]"><NotificationBell /></span>
            <Link
              to="/dashboard"
