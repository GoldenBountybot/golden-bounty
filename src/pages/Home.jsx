          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <div className="relative shrink-0 self-end translate-y-[13px] w-12 h-12">
              <button
                ...
                className="absolute -top-[34px] left-1/2 translate-x-[calc(-50%+34px)] flex items-center gap-1.5 pl-2 pr-2.5 py-1 rounded-full transition-all active:scale-95 z-30"
                style={{
              ...
              <Link
                to="/airdrop"
                title="Airdrop"
                className="absolute top-[2px] left-1/2 -translate-x-1/2 flex items-center gap-1.5 pl-2 pr-2.5 py-1 rounded-full transition-all active:scale-95 z-30"
                style={{
