...
export default function HiLo() {
  ...
  const guess = (dir) => {
    ...
    const wantCorrect = withinCap && Math.random() < (rtpFrac / 2);
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ background: 'radial-gradient(ellipse at 50% 0%, #071D14 0%, #03150F 55%, #050806 100%)', fontFamily: SERIF }}>
      ...
      <main className="max-w-md lg:max-w-5xl mx-auto px-3 py-4 flex flex-col items-center gap-4 relative z-10">
