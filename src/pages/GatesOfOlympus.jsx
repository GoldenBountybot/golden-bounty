...
export default function GatesOfOlympus() {
  ...
  if (!ready) {
    return (
      <GameAssetLoader
        ...
        bgImage="https://cdn.jsdelivr.net/gh/GoldenBountybot/golden-bounty-assets@main/b44/1f0dcd8e1_file_00000000534882308373132046ad84c6.png"
      />
    );
  }
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('https://cdn.jsdelivr.net/gh/GoldenBountybot/golden-bounty-assets@main/b44/1f0dcd8e1_file_00000000534882308373132046ad84c6.png'), linear-gradient(to bottom, #3a1060, #1a0530)",
