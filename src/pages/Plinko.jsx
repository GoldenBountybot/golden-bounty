    ...
    <div className="min-h-screen text-white flex flex-col" style={{ background: 'radial-gradient(circle at 50% 0%, #1a0f2e 0%, #0a0a12 55%, #000 100%)', fontFamily: FONT }}>
      ...
      <main className="relative z-10 max-w-2xl mx-auto w-full px-3 flex-1 flex flex-col">
        ...
        <div className="p-2 flex items-center gap-2" style={{ ...woodFrame, marginTop: '-80px' }}>
          <button onClick={() => setShowCustom(s => !s)} className={`w-10 h-10 flex items-center justify-center ${showCustom ? 'ring-2 ring-amber-300' : ''}`} style={{ ...woodBtn, color: customBet != null ? '#f5c542' : '#d9b97a', transform: 'translateY(12px)' }} title="Custom bet">
