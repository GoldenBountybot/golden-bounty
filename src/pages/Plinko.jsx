  ...
  return (
    <div className="min-h-screen text-white flex flex-col" style={{ background: 'radial-gradient(circle at 50% 0%, #1a0f2e 0%, #0a0a12 55%, #000 100%)', fontFamily: FONT }}>
      ...
      <main className="relative z-10 max-w-2xl mx-auto w-full px-3 flex-1 flex flex-col">
        ...
        <div className="mx-auto relative" style={{ width: '66.67%', marginTop: '-8px' }}>
        ...
        <div className="p-2 flex items-center gap-2" style={{ ...woodFrame, marginTop: '-6px' }}>
        ...
        <button
          ...
          style={{ width: '66.67%', marginTop: '-6px' }}
        >
          <img
            src={DROP_BTN_IMG}
            alt="Drop"
        ...
        {/* Stats — wooden tiles */}
        <div className="grid grid-cols-3 gap-2 pb-4 text-center" style={{ marginTop: '-6px' }}>
