  ...
  return (
    <div className="relative text-center" style={{ fontFamily: FONT }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none" style={{ transform: 'translateY(-2px)' }}>
        <p className="text-[9px] tracking-widest uppercase" style={{ color: '#f5c542', textShadow: '0 1px 2px rgba(0,0,0,0.8)' }}>{label}</p>
        <p className="text-[11px] font-bold tabular-nums" style={{ color: accent ? '#f5c542' : '#f3e2b3', textShadow: '0 1px 2px rgba(0,0,0,0.8)' }}>{value}</p>
      </div>
    </div>
  );
}
