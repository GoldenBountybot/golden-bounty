...
export default function InfoLayout({ title, subtitle, icon: Icon, children }) {
  ...
  return (
    <div className="relative min-h-screen pb-20 lg:pb-6" style={{ background: '#0D0D0D', fontFamily: SANS }}>
      ...
      >
        <div className="relative max-w-none mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-2 pointer-events-none">
            ...
            <span className="text-lg font-extrabold tracking-tight whitespace-nowrap" style={{ color: '#D4AF37' }}>{title}</span>
          </div>
        </div>
      </header>

      <main className="relative z-10 max-w-none mx-auto px-4 py-6">
