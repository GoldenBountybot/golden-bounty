    ...
    >
      ...
      <div className="relative flex items-center gap-1.5 px-2 py-1.5 w-full">
        ...
        <div className="flex flex-col leading-tight min-w-0">
          <span className="text-[9px] italic text-amber-300/90 tracking-[0.18em] uppercase" style={{ fontFamily: 'Rye, Georgia, serif', textShadow: '0 1px 1px rgba(0,0,0,0.6)' }}>
            {label}
          </span>
          <span className="text-sm font-bold italic text-yellow-100 tabular-nums truncate" style={{ fontFamily: 'Rye, Georgia, serif', textShadow: '0 1px 2px rgba(0,0,0,0.7)' }}>
            {value}
          </span>
        </div>
      </div>
