      ...
      {(decorFrame || goldFramed) && img && symbolId !== 'scatter' ? (
        <>
          ...
          <img
            ...
            style={{ '--bs': baseScale, transform: spinning ? 'none' : `scale(${baseScale})`, zIndex: 5, willChange: popAnim ? 'transform, filter' : 'auto', animation: popAnim }}
          />
        </>
      ) : img ? (
        <>
          ...
          <img
            ...
            loading="lazy"
            className="w-full h-full object-cover"
            style={{ '--bs': baseScale, transform: spinning ? 'none' : `scale(${baseScale})`, willChange: popAnim ? 'transform, filter' : 'auto', animation: popAnim, filter: spinning ? undefined : (isScatter ? 'brightness(1.4) drop-shadow(0 0 6px rgba(255,235,150,0.75))' : undefined) }}
          />
        </>
      ) : isCard ? (
        <div
