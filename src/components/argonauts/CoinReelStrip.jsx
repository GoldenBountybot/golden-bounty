...
// Continuous coin reel strip — scrolls exactly like the main ArgoSpinStrip
// (tall seamless column with `reelFall`), just slowed down into slow motion so
// each falling coin's dollar label stays legible while it descends.
export default function CoinReelStrip({ turbo, bet = 0 }) {
  const period = turbo ? 2.2 : 3.4;
