  ...
  return (
    <div ref={machineRef} className="relative w-full max-w-md mx-auto flex flex-col overflow-hidden select-none"
      ...
      <div className="relative flex items-center justify-start shrink-0 pt-10 pb-0 pl-3"
        style={{ background: 'linear-gradient(to bottom,rgba(50,10,90,0.95),transparent)', marginBottom: 10, zIndex: 20 }}>
        ...
        <img src="https://media.base44.com/images/public/6a5698edffaa42a5b6637776/84fd16eb6_file_00000000e474820ba9fd196f5f5c9f06.png"
          ...
          style={{ position: 'absolute', right: '-20%', bottom: -12, width: '58%', maxWidth: 220,
