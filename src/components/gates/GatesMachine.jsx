  ...
  return (
    <div ref={machineRef} className="relative w-full max-w-md mx-auto flex flex-col overflow-hidden select-none"
      ...
      <div className="relative flex items-center justify-center shrink-0"
        style={{ background: 'transparent', marginTop: 2, marginBottom: -28, zIndex: 20, lineHeight: 0 }}>
        <img src="https://media.base44.com/images/public/6a5698edffaa42a5b6637776/4ada8e43f_file_000000009d6c820683b5d0deb9bc731a.png"
          ...
          style={{ width: '52%', maxWidth: 240, height: 'auto', objectFit: 'contain',
            display: 'block', transform: 'translateY(20px)',
