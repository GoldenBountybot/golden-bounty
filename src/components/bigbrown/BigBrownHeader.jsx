...
// Slim single-row header for Big Brown: back button, inline title, balance
// chip and sound toggle all on one compact line.
export default function BigBrownHeader({ title, balance }) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 px-2 py-1">
        <BackButton />
        <span
          className="flex-1 truncate text-[13px] font-black italic"
          style={{
            fontFamily: 'Rye, Georgia, serif',
            background: 'linear-gradient(to bottom,#f5d590,#c8912f)',
